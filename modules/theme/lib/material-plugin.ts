  ...
  },
  {
    theme: {
      ...
      colors: {
        ...
        'primary-fixed':
          'rgb(var(--md-sys-color-primary-fixed-rgb) / <alpha-value>)',
        'on-primary-fixed':
          'rgb(var(--md-sys-color-on-primary-fixed-rgb) / <alpha-value>)',
        'secondary-fixed':
          'rgb(var(--md-sys-color-secondary-fixed-rgb) / <alpha-value>)',
        'on-secondary-fixed':
          'rgb(var(--md-sys-color-on-secondary-fixed-rgb) / <alpha-value>)',
        'tertiary-fixed':
          'rgb(var(--md-sys-color-tertiary-fixed-rgb) / <alpha-value>)',
        'on-tertiary-fixed':
          'rgb(var(--md-sys-color-on-tertiary-fixed-rgb) / <alpha-value>)',

        'inverse-surface': {
          DEFAULT:
            'rgb(var(--md-sys-color-inverse-surface-rgb) / <alpha-value>)',
          light:
            'rgb(var(--md-sys-color-inverse-surface-light-rgb) / <alpha-value>)',
          dark: 'rgb(var(--md-sys-color-inverse-surface-dark-rgb) / <alpha-value>)'
        },
        'on-inverse-surface': {
          DEFAULT:
            'rgb(var(--md-sys-color-on-inverse-surface-rgb) / <alpha-value>)',
          light:
            'rgb(var(--md-sys-color-on-inverse-surface-light-rgb) / <alpha-value>)',
          dark: 'rgb(var(--md-sys-color-on-inverse-surface-dark-rgb) / <alpha-value>)'
        },
        'surface-level-1': {
